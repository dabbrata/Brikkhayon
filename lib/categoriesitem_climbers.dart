...
class Item extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: CategoriseItemClimbers(),
    );
  }
}


class CategoriseItemClimbers extends StatefulWidget {



  @override
  _CategoriseItemClimbersState createState() => _CategoriseItemClimbersState();
}
...
class _CategoriseItemClimbersState extends State<CategoriseItemClimbers> {
                    ...
                    builder: (context,
                      ...
                      try{
                        if (!snapshot.hasData) {
                          ...
                          listi.clear();
                          list.clear();
                          listi = map.values.toList();
                          print('Before');
                          print(listi[0]['z_category']);
                          for(int i=0;i<listi.length;i++){
                            if(listi[i]['z_category'] == 'Climbers'){
                              list.add(listi[i]);
//                            print(list[i]['z_category']);
                            }
                          }
                          print(list[0]['name']);
                          print('after');
