...
class _TransactionState extends State<Transactions> {
  ...
  final dataRef = FirebaseDatabase.instance.ref().child('allOrders');
  final dataRef2 = FirebaseDatabase.instance.ref().child('orders').child(FirebaseAuth.instance.currentUser!.uid);
