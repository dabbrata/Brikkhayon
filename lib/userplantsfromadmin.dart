...
//String identity=" ";
class UserPlantFromAdmin extends StatefulWidget {
  String userId,userName;
  UserPlantFromAdmin({Key? key,required this.userId,required this.userName}) : super(key: key);

  @override
  State<UserPlantFromAdmin> createState() => _UserPlantFromAdminState();
}

class _UserPlantFromAdminState extends State<UserPlantFromAdmin> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: Container(
        child: StreamBuilder(
          stream: FirebaseDatabase.instance.ref().child("plantdetails").child(widget.userId.toString()).onValue,
          builder: (context,
